"""
Django settings for lambdaacademy project.
...
SECRET_KEY = 'x(+*!is612*%$2lu=e*40q(37+zr%x=$p@wj%r#u9j9=-)5a*8'
...
ROOT_URLCONF = 'lambdaacademy.urls'
...
WSGI_APPLICATION = 'lambdaacademy.wsgi.application'
